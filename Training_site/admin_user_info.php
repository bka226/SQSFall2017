...
//Add/remove group members		
		...
		echo "User email: <input type=\"text\" name=\"username\" id=\"txt_adminUsernameAdd\">";
		
		echo "Group to add to: <input type=\"text\" name=\"group_name\" id=\"txt_adminGroupAdd\">";
		
		echo "<button class = \"btn btn-primary\" type=\"submit\" id=\"btn_adminGroupAdd\" value=\"Add\"> Add </button>";
		echo "</form>";
		...
		echo "User email: <input type=\"text\" name=\"username\" id=\"txt_adminUsernameRemove\">";
		
		echo "Group to remove from: <input type=\"text\" name=\"group_name\" id=\"txt_adminGroupRemove\">";
		
		echo "<button class = \"btn btn-primary\" type=\"submit\" id=\"btn_adminGroupRemove\" value=\"Remove\"> Remove </button>";
		echo "</form>";
		echo "</td>";
		echo "</tr>";
		echo "<tr>";
...
//Add/remove group leaders
		...
		echo "User email: <input type=\"text\" name=\"username\" id=\"txt_adminUsernameLeaderAdd\">";
		
		echo "Group to promote in: <input type=\"text\" name=\"group_name\" id=\"txt_adminGroupLeaderAdd\">";
		
		echo "<button class = \"btn btn-primary\" type=\"submit\" id=\"btn_adminLeaderAdd\" value=\"Add\"> Add </button>";
		echo "</form>";
		echo "</td>";
		echo "</tr>";
		...
		echo "User email: <input type=\"text\" name=\"username\" id=\"txt_adminUsernameLeaderRemove\">";
		
		echo "Group to demote from: <input type=\"text\" name=\"group_name\" id=\"txt_adminGroupLeaderRemove\">";
		
		echo "<button class = \"btn btn-primary\" type=\"submit\" id=\"btn_adminGroupLeaderRemove\" value=\"Remove\"> Remove </button>";
		echo "</form>";
		echo "</td>";
		echo "</tr>";
		echo "<tr>";
