# CS499 Fall 2017 Group 6 SQS Training Site README
...
All code changes made over the course of the 2017 Fall Semester development have an associated pull request and refrenced issue on the GitHub page. To trace a code alteration find the file changed, view its history through the GitHub interface, and find the associated commit and pull request name.
